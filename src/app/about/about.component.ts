...
export class AboutComponent implements OnInit {
  ...
  public personalInfo:PersonalInformation = {
        ...
        description: "Full Stack developer. Currently working as a Senior Consultant developing web solutions with Adobe Experience Manager. Exploring different Web Technologies on my free time.",
